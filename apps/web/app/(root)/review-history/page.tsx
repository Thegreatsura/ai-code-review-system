...
import { BookMarked, Check, ChevronLeft, ListFilter, Search } from 'lucide-react';
...
const ReviewHistoryPage = () => {
    ...
    const [popoverView, setPopoverView] = useState<'main' | 'repos'>('main');
    ...
    const filteredReviews = useMemo(() => {
        ...
        return result;
    }, [reviews, searchQuery, selectedRepo, sortBy]);
            ...
            <div className="px-6 py-6 w-full max-w-7xl mx-auto">
                <div className="mb-6 w-full flex items-center gap-2">
                    ...
                    <Popover open={isPopoverOpen} onOpenChange={setIsPopoverOpen}>
                        <PopoverTrigger>
                            <button
                                className={`border border-[#242424] hover:bg-[#242424]/35 group px-2 py-2 rounded-md transition-colors ease-in-out duration-200 ${selectedRepo ? 'bg-[#242424]/50' : ''}`}
                            >
                            ...
                            {popoverView === 'main' ? (
                                <div className="flex flex-col py-2">
                                    ...
                                    <button
                                        ...
                                        className="flex items-center gap-1 px-4 py-2 hover:bg-neutral-800 font-medium font-mono transition-colors text-sm text-white"
                                    >
                                        <BookMarked size={14} className="" />
                                        Repository
                                    </button>
