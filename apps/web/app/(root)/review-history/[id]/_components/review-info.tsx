...
export const ReviewInfo = memo(
    ({ prNumber, repositoryFullName, totalMs, queuedAt, startedAt, prUrl }: ReviewInfoProps) => {
        return (
            <div className="flex flex-wrap py-2 px-4 gap-y-2 gap-x-6 pb-2">
                <div className="flex flex-col gap-1">
                    ...
                    <span className="text-black text-sm font-medium truncate max-w-30">{prNumber}</span>
                </div>
                <div className="flex flex-col gap-1">
                    ...
                    >
                        <GitHubIcon />
                        <span className="text-sm font-medium text-blue-400">{repositoryFullName}</span>
                    </Link>
                </div>
                <div className="flex flex-col gap-1">
