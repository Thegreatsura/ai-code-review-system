...
export const MessageResponse = memo(
    ({ className, ...props }: MessageResponseProps) => (
        <Streamdown
            className={cn(
                'size-full [&>*:first-child]:mt-0 [&>*:last-child]:mb-0 text-neutral-200 [&_code]:bg-neutral-500 [&_code]:text-black [&_pre]:!bg-neutral-500 [&_pre]:!text-black [&_pre]:rounded-lg [&_pre]:p-4',
                className,
            )}
